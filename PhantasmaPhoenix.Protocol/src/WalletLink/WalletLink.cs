...
public abstract class WalletLink
{
	...
	protected abstract void SignTransactionSignature(PhantasmaPhoenix.Protocol.Transaction transaction, string platform,
		SignatureKind kind, Action<PhantasmaPhoenix.Cryptography.Signature, string> callback);
	...
	private void HandleAuthorize(string[] args, Connection connection, int id, Action<int, JToken, bool> callback)
	{
		JToken answer;
		bool success = false;
	...
	#region Account
	private void HandleGetAccount(string[] args, Connection connection, int id, Action<int, JToken, bool> callback)
	{
		int expectedLength;
		JToken answer;
		bool success = false;
	...
	private void HandleGetNexus(string[] args, Connection connection, int id, Action<int, JToken, bool> callback)
	{
		JToken answer;
		bool success = false;
	...
	private void HandleGetN3Address(string[] args, Connection connection, int id, Action<int, JToken, bool> callback)
	{
		JToken answer;
		bool success = false;
	...
	#region Peer
	private void HandleGetPeer(string[] args, Connection connection, int id, Action<int, JToken, bool> callback)
	{
		JToken answer;
		bool success = false;
	...
	private void HandleGetWalletVersion(string[] args, Connection connection, int id, Action<int, JToken, bool> callback)
	{
		JToken answer;
		bool success = false;
	...
	private void HandleSignData(string[] args, Connection connection, int id, Action<int, JToken, bool> callback)
	{
		int expectedLength;
		JToken answer;
		bool success = false;
	...
	private void HandleSignTx(string[] args, Connection connection, int id, Action<int, JToken, bool> callback)
	{
		int index = 0;
		JToken answer;
		bool success = false;
	...
	private void HandleSignTxSignature(string[] args, Connection connection, int id,
		Action<int, JToken, bool> callback)
	{
		int expectedLength;
		JToken answer;
		bool success = false;
		...
		var transaction = PhantasmaPhoenix.Protocol.Transaction.Unserialize(data);
	...
	private void HandleMultiSig(string[] args, Connection connection, int id, Action<int, JToken, bool> callback)
	{
		int expectedLength;
		JToken answer;
		bool success = false;
	...
	private void HandleInvokeRawScript(string[] args, Connection connection, int id, Action<int, JToken, bool> callback)
	{
		bool success = false;
		JToken answer;
		if (args.Length != 2)
